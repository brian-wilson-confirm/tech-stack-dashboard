  ...
  <Tabs defaultValue="profile" className="w-full">
    ...
    <TabsContent value="profile">
      <form className="space-y-6 max-w-xl" onSubmit={e => { e.preventDefault(); onSave(); }}>
        <div>
          <label className="block text-sm font-medium mb-1">Learning Preferences & Goal Settings</label>
    ...
    <TabsContent value="preferences">
      <div className="p-6 text-muted-foreground">Preferences form goes here.</div>
    </TabsContent>
  </Tabs>
);
