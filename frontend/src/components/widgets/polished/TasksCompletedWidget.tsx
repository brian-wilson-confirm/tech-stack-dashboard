...
const chartData = [
  ...
  //{ date: "2024-07-01", tasks: 103, mobile: 160 }, by category? by level? Technology?
]
        ...
        >
          <ResponsiveContainer width="100%" height={250}>
            ...
            >
              ...
              />
              {/* @ts-ignore */}
              <Tooltip content={ <ChartTooltipContent label={""} value={""} /> }
              />
              {/* @ts-ignore */}
              <Bar dataKey={activeChart} fill="#3b82f6" />
            </BarChart>
          </ResponsiveContainer>
        </ChartContainer>
      </CardContent>
