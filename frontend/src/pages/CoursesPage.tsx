...
import { Course, courseFormSchema, Lesson, LessonForm, lessonFormSchema } from '@/components/data/schema'
import { CourseForm } from '@/components/data/schema'
...
********************/
function ShowAddCourseDialog({ onAddItem, disabled }: { onAddItem: (item: CourseForm) => Promise<any>, disabled?: boolean }) {
        ...
        <DialogContent className="sm:max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Button type="submit" disabled={isSubmitting}>
                    {isSubmitting ? (
                    <>
                        <span className="animate-spin mr-2">⏳</span> Adding Course...
                    </>
                    ) : 'Add Course'}
                </Button>
                </DialogFooter>
...
export default function CoursesPage() {
  ...
  ***********************/
  ...
  /***********************
    ROW INTERACTION
  ***********************/
  const handleRowClick = useCallback((row: Course) => {
  ...
  ********************/
  const editModeRenderers: EditModeRenderer<Course> = {
  ...
  /*******************
    ADD NEW COURSE
  ********************/
  const handleAddCourse = async (newCourse: CourseForm) => {
    console.log('Adding newCourse to the table', newCourse)
    try {
        ...
        console.log('Fetched updated courses', courses)
        ...
        return courses[courses.length - 1] // Return the newly added course
    } catch (error) {
    ...
    <div className="p-8">
      ...
      <div className="grid gap-6">
        <DataTableWidget
          ...
          showCheckboxes={true}
          showActions={true}
          AddItemDialog={ShowAddCourseDialog}
