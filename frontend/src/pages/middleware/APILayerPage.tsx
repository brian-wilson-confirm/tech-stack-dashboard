...
export default function APILayerPage() {
  ...
  const fetchRows = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to load API layers.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  return (
    <div className="p-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-3xl font-bold">API Layers</h1>
      </div>
